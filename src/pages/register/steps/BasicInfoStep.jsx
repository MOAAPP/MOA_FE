  ...
  return (
    <div className="basic-info-step">
      <RegisterStepHeader
        ...
        subtitle="학습을 시작하기 위한 정보를 입력해주세요"
      />
      ...
      <div className="basic-info-fields">
        ...
        <div className="app-input-group">
          <label htmlFor="birthDate" className="app-input-label">
            생년월일
          </label>
          ...
          <button
            id="birthDate"
            type="button"
            className={`basic-info-date-btn${
              value.birthDate ? " basic-info-date-btn--filled" : ""
            }`}
          ...
          >
            <span
              className={
                value.birthDate
                  ? "basic-info-date-value"
                  : "basic-info-date-placeholder"
              }
            >
              {value.birthDate
        ...
        <div className="app-input-group">
          ...
          <div className="basic-info-phone-row">
            <div className="app-input-row basic-info-phone-input">
              <input
                id="phone"
                type="tel"
                value={value.phone ?? ""}
            ...
            <button
              type="button"
              className={`basic-info-action-btn${
                verificationSent ? " basic-info-action-btn--sent" : ""
              }`}
